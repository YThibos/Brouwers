...
class BrouwerRepositoryImpl implements BrouwerRepository {
	...
	BrouwerRepositoryImpl() {
		...
		brouwers.put(3L, new Brouwer(3L, "AB InBev", new Adres("Ergens in Leuven ofzo", "2", 2000, "Leuven"), 500_000));
		brouwers.put(4L, new Brouwer(4L, "Heineken", new Adres("Pisstraat", "1", 9999, "Kaasdorp"), 5_000));
	}
